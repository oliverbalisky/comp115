...
assert reverse_str('1,2,3') == ('3,2,1')
...
assert count_vowels("HI I love to eat banana") == 10

assert count_vowels("PAPA") == 2
...
def remove_duplicates(s):
    ...
    for char in s:
        ...
        if char not in shortend:

            shortend = shortend + char
...
assert remove_duplicates("feel") == ("fel")

assert remove_duplicates("PApa") == ("PApa")
...
assert project_completion_day('Wednesday', 7) == ('Wednesday')
