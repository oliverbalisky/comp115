...
assert average ([3,56,74,28]) == 40.25
...
assert find_max([1,2,3,10,6,8]) == 10
...
assert evens([1,2,3,4,3,6,7,8]) == [2,4,6,8]
...
"""
Congratulations on finishing your lab4. This is a big move (yeah fr, alice)!
